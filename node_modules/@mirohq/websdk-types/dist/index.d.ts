...
export type UnsupportedType = 'curve' | 'document' | 'emoji' | 'table' | 'kanban' | 'mockup' | 'svg' | 'usm' | 'mindmap' | 'webscreen' | 'connector' | 'stencil' | 'unsupported'; // Default case
...
export type Item = Card | AppCard | Frame | Image | Unsupported | Preview | Shape | StickyNote | Text | Embed;
...
type AppEventType = 'icon:click' | 'app_card:open' | 'selection:update';
